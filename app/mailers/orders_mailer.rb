class OrdersMailer < ActionMailer::Base
  ...
  def create_mission_attachment order 
    ...
    file.puts "3  0 3 184 5.000000  2000.000000  1.000000  0.000000  0.000000     0.000000     0.000000     1"
  	file.puts "4	0	3	21	0.000000	0.000000	0.000000	0.000000	0.000000	0.000000	0.000000	1"
  	file.close
  	file_path
  end
